    ...
    <footer className="border-t border-white/10 bg-[#0a0a0a]">
              ...
              {subscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex gap-0">
                  <input
                    ...
                    className="flex-1 min-w-0 px-4 py-2.5 bg-[#141414] border border-white/10 text-xs text-white/70 placeholder-white/30 focus:outline-none focus:border-white/20 transition-colors"
                  />
                  <button type="submit" className="px-4 py-2.5 bg-[#141414] border border-white/10 border-l-0 text-[0.6rem] tracking-[0.15em] uppercase text-white/30 hover:bg-[#1a1a1a] transition-colors whitespace-nowrap">
                    Subscribe
                  </button>
                </form>
              )}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[0.6rem] text-white/30">© 2026 Atelier. All rights reserved.</p>
          <div className="flex gap-5">
            <a href="#" className="text-[0.6rem] text-white/30 hover:text-white/30 transition-colors" aria-label="Twitter">Twitter</a>
            <a href="#" className="text-[0.6rem] text-white/30 hover:text-white/30 transition-colors" aria-label="Instagram">Instagram</a>
            <a href="#" className="text-[0.6rem] text-white/30 hover:text-white/30 transition-colors" aria-label="Pinterest">Pinterest</a>
          </div>
        </div>
      </div>
    </footer>
