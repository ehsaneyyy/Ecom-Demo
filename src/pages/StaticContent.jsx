...
const pages = {
  '/about': {
    title: 'About Ecom Demo',
    sections: [
      { heading: 'Our Story', text: 'Founded in 2024, Ecom Demo was born from a simple belief: the objects we surround ourselves with shape our daily experience. We partner directly with independent makers and small studios who share our commitment to craft, quality, and sustainability.' },
  ...
  '/returns': {
    ...
    sections: [
      ...
      { heading: 'Exchanges', text: 'Need a different size or color? Contact us at hello@ecom-demo.com and we\'ll arrange an exchange. We cover shipping on exchanges for defective or incorrect items.' },
  ...
  '/faq': {
    ...
    sections: [
      ...
      { heading: 'Can I change or cancel my order?', text: 'Orders can be modified or cancelled within 2 hours of placing them. After that, we begin processing and cannot make changes. Contact us immediately at hello@ecom-demo.com if you need to make a change.' },
      ...
      { heading: 'Do you offer wholesale?', text: 'Yes, we offer wholesale pricing for qualified retailers. Contact us at wholesale@ecom-demo.com with your business details and we\'ll get back to you within 48 hours.' },
    ],
  },
  '/privacy': {
    title: 'Privacy Policy',
    sections: [
      { heading: 'Information We Collect', text: 'When you visit Ecom Demo, we automatically collect certain information about your device, including your web browser, IP address, time zone, and some cookies. We also collect information about the individual web pages you view, what websites or search terms referred you, and how you interact with the site.' },
      ...
      { heading: 'Your Rights', text: 'If you are a European resident, you have the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. You may contact us at privacy@ecom-demo.com.' },
  ...
  '/terms': {
    ...
    sections: [
      { heading: 'Overview', text: 'This website is operated by Ecom Demo. Throughout the site, the terms "we," "us," and "our" refer to Ecom Demo. By visiting our site and/or purchasing something from us, you engage in our service and agree to be bound by the following terms.' },
      ...
      { heading: 'Contact', text: 'Questions about the Terms of Service should be sent to us at legal@ecom-demo.com.' },
    ],
  },
}
