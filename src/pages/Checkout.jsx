...
export default function Checkout() {
  ...
  if (submitted) {
    return (
      <div className="animate-fade-in min-h-[60vh] flex flex-col items-center justify-center px-4 text-center">
            ...
            <div className="animate-fade-in space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input value={payment.expiry} onChange={(e) => setPayment({ ...payment, expiry: e.target.value })} placeholder="MM/YY" className={`w-full px-4 py-3 bg-white/5 border text-sm text-white/70 placeholder-white/15 focus:outline-none focus:border-white/20 transition-colors ${errors.expiry ? 'border-red-500/50' : 'border-white/10'}`} />
                ...
                <div>
                  ...
                  <input value={payment.cvc} onChange={(e) => setPayment({ ...payment, cvc: e.target.value })} placeholder="123" className={`w-full px-4 py-3 bg-white/5 border text-sm text-white/70 placeholder-white/15 focus:outline-none focus:border-white/20 transition-colors ${errors.cvc ? 'border-red-500/50' : 'border-white/10'}`} />
            ...
            <div className="animate-fade-in space-y-6">
              ...
              <div className="bg-[#141414] p-5 sm:p-6 rounded-lg space-y-4">
                ...
                <div className="border-t border-white/5 pt-4">
                  ...
                  <p className="text-sm text-white/60">Card ending in {payment.cardNumber.slice(-4)}</p>
                </div>
                <div className="border-t border-white/5 pt-4">
              ...
              <div className="flex justify-between pt-4">
                ...
                <button onClick={handlePlaceOrder} className="px-8 py-3.5 bg-white text-black text-xs tracking-[0.15em] uppercase hover:bg-white/90 transition-colors min-h-[48px]">
                  Place Order
                </button>
              </div>
            </div>
