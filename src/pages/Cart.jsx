          ...
          {items.map((item, i) => {
            ...
            return (
              <Reveal key={itemKey} delay={i * 60}>
                <div className={`flex gap-4 sm:gap-6 py-6 sm:py-8 border-b border-white/5 transition-opacity duration-200 ${isRemoving ? 'opacity-0' : 'opacity-100'}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      ...
                      <button
                        ...
                        className="text-[0.6rem] text-white/20 hover:text-[#c85a3e]/60 transition-colors"
                      >
                        Remove
                      </button>
                    </div>
