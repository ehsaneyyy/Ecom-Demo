...
function Loading() {
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-5 h-5 border border-theme-border border-t-theme-text rounded-full animate-spin" />
    </div>
  )
}
          ...
          <AuthProvider>
            <DataProvider>
              <CartProvider>
                <WishlistProvider>
                  <Layout>
                    <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[200] focus:px-4 focus:py-2 focus:bg-theme-surface focus:text-theme-text focus:text-xs">
                      Skip to content
                    </a>
                    <ErrorBoundary>
