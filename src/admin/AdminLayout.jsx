    ...
    <div className="flex h-screen bg-[#0a0a0a]">
      <div className="hidden md:flex md:w-56 md:flex-shrink-0">
        <div className="w-56 bg-[#111] border-r border-white/5 flex flex-col">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                    isActive ? 'bg-white/10 text-white/90' : 'text-white/30 hover:text-white/60 hover:bg-white/5'
                  }`
                }
              >
          ...
          <div className="p-4 border-t border-white/5">
            <NavLink to="/" className="flex items-center gap-2 text-xs text-white/20 hover:text-white/40 transition-colors">
              ← Back to Store
            </NavLink>
          </div>
        </div>
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-[#111] border-r border-white/5 shadow-2xl animate-slide-down">
            <div className="h-16 flex items-center px-6 border-b border-white/5">
              <span className="text-xs font-semibold tracking-[0.2em] text-white/50">ATELIER ADMIN</span>
            </div>
            ...
            <div className="p-4 border-t border-white/5">
              <NavLink to="/" onClick={() => setSidebarOpen(false)} className="flex items-center gap-2 text-xs text-white/20 hover:text-white/40 transition-colors">
                ← Back to Store
              </NavLink>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b border-white/5 flex items-center px-4 sm:px-6 gap-4 flex-shrink-0">
          <button
            ...
            className="md:hidden w-10 h-10 flex items-center justify-center text-white/40 hover:text-white/70 transition-colors"
          ...
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center text-[0.5rem] text-white/40">
              A
            </div>
